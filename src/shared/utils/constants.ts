...
export const WATER_NEEDS = "Water Needs:";
export const BLOOM_SEASON = "Bloom Season:";
export const CARE_LEVEL = "Care Level:";

export const SOMETHING_WRONG = "something is wrong. Please try again";
